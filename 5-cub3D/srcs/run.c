...
/*   Updated: 2020/01/27 07:04:11 by anradix          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*void	load_textures(main_strct *m_ptr)
{
	...
	m_ptr->textures.wall_w = mlx_xpm_file_to_image(m_ptr->mlx.mlx_init, m_ptr->textures.path_wall_w, &h, &w);
}*/
...
{
	m_ptr->mlx.mlx_init = mlx_init();
	m_ptr->mlx.win = mlx_new_window(m_ptr->mlx.mlx_init, m_ptr->map.width, m_ptr->map.height, "Cub3d - anradix");
	raycasting(m_ptr);
